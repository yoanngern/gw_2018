...
function register_my_menu() {
	register_nav_menu( 'principal', __( 'Menu principal', 'gospelwave' ) );
	register_nav_menu( 'top', __( 'Menu top', 'gospelwave' ) );
}
...
add_image_size( 'banner', 1920, 460, true );
add_image_size( 'summary', 480, 480, true );
